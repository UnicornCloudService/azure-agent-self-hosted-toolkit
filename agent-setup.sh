...
su -c "cd $AGENT_INSTALL_DIR && ./config.sh --replace --acceptTeeEula --url "https://dev.azure.com/${AZP_ORGANIZATION}" --auth pat --token $AZP_TOKEN --pool $POOL --agent $AGENT_USER" $AGENT_USER
